...
def upgrade() -> None:
    """Upgrade schema."""
    # Add columns to invoices table (user_id handled conditionally)
    ...
    # Create indexes and foreign key constraints for invoices
    ...
    # Update constraints for stock_movements and warehouse_documents
...
def downgrade() -> None:
    """Downgrade schema."""
    # Revert constraints on warehouse_documents and stock_movements
    op.alter_column('warehouse_documents', 'created_at',
               existing_type=sa.DATETIME(),
               nullable=True)
    op.alter_column('warehouse_documents', 'invoice_id',
