...
def upgrade() -> None:
    ...
    # USUNĘLIŚMY STĄD WSZYSTKIE POLECENIA 'drop_table' i 'drop_index'
    ...
    # USUNĘLIŚMY STĄD WSZYSTKIE POLECENIA 'alter_column' i 'create_index'
...
def downgrade() -> None:
    ...
    # USUNĘLIŚMY STĄD WSZYSTKIE POLECENIA 'create_table' i 'create_index'
